...
<div class="form-group">
  ...
  <img src="/{{$post->image}}" class="rounded" style="height:130px;max-width:130px; object-fit:cover;">
  <p>  <small>Please select a new image if you'd like to update or leave this blank in order to not change the image.</small>
  </p>
  @endif
