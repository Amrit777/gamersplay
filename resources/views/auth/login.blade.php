    ...
    <div class="card" style="width:25rem; border-radius:10px 10px 0 0; margin-top:70px; border:0px;">
        ...
        <div class="card-body">
            ...
            <div style="display:flex; align-items:center;">
                <input type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} style="width:initial; margin-right:10px; ">
                ...
                <div class="row" style="justify-content: center">
                    <a href="/auth/discord"><img src="{{asset('imgs/auth/discord.jpg')}}" alt="" style="height:28px;"></a>
                </div>
            </div>
