                ...
                <div class="row" style="padding:15px;">
                       ...
                       <form method="POST" enctype="multipart/form-data" id="ajax-profile" action="javascript:void(0)">
                        ...
                        <div style="display:Flex; justify-content:center; flex-direction:column;">
                            <div style="text-align: center;">
                                <img src="{{$user->profile_picture}}" style="height:128px; width:128px; object-fit:cover; max-width:128px;  border-radius:50%; border:4px solid white;" id="profile_picture_img">
                                <div>
                        ...
                        <div style="margin:2px auto;">
                            <button class="btn btn-success" id="saveBtn" type="submit" style="display:none;">Save</button>
                            <a class="btn btn-danger" href="/profile/{{$user->id}}/removeAvatar">Remove</a>
                        </div>
                        ...
                        <div style="display:Flex; justify-content:center; flex-direction:column;">
                            <div style="text-align: center;">
                                <img src="{{asset('/imgs/avatar.svg')}}" style="height:128px; width:128px; object-fit:cover; max-width:128px;  border-radius:50%; border:4px solid white;" id="profile_picture_img">
                                <div>
                                    <small>Click on the image to change profile photo.</small>
                                </div>
                                <input type="file" name="profile_picture" id="profile_picture" style="display:none;">
                        ...
                        <br>
                        <div style="margin:2px auto;">
                            <button class="btn btn-success" type="submit" id="saveBtn" style="display:none;">Save</button>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" value="{{$user->user_title}}">
                        </div>
                        {{-- Form Element --}}
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                          ...
                          <textarea type="text" name="description" class="form-control" rows="3">{{$user->description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="facebook_profile" class="input" style="margin-bottom:10px;" placeholder="facebook.com/gamersplay" value="{{$user->facebook_profile}}">
                        <label for="">Twitch</label>
                        <input type="text" name="twitch_profile" class="input" placeholder="twitch.tv/gamersplay" value="{{$user->twitch_profile}}">
                    </div>
                    <div class="col-md-4">
                        <br>
                        <label for="">Instagram</label>
                        <input type="text" name="instagram_profile" class="input" placeholder="@gamersplay" value="{{$user->instagram_profile}}">
                    </div>
                    <div class="col-md-4">
                        <br>
                        <label for="">Discord</label>
                        <input type="text" name="discord_handle" class="input" placeholder="GamersPlay#0000" value="{{$user->discord_handle}}">
                    </div>
