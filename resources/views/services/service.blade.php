...
<div class="menu-navbar" style="position:fixed !important;" data-simplebar>
    ...
    <div id="menu_categories_-1" class="menu_category">
        <ul class="menu_ul">
            ...
            <div class="categories_box_holder" style="background-image:linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('{{$category->image_1}}');">
                @else
...
<div style="margin-left:260px;" id="services_container_responsive">
    ...
    <div class="header-page rounded">
        ...
        <div>
            <h1>Services <span id="category_name"></span> <img src="/imgs/sidebar.png" style="height:32px; float:right; position:relative;top:2px;" class="showMenu"></h1>

            <p>Here you can browse GamersPlay Sellers and find a perfect match!</p>
        </div>
    </div>

    <div id="filters" style="display:none; align-items:center; justify-content:flex-end; background:white; border-radius:20px; padding:20px 15px; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
        ...
        <div class="services_filterable">
            ...
            <br>
            <input type="number" class="input" id="minRating" min="1" max="5" style="width:80px;" step="0.1" min="16">
        </div>
        <div class="services_filterable">
            <label for="">Price</label>
            <div style="display:flex; justify-content:space-between;">
                <input type="number" class="input" placeholder="Min" id="priceMin" min="0.01" step="0.01" style="width:80px; margin-right:5px;">
                <input type="number" class="input" placeholder="Max" id="priceMax" min="0.01" step="0.01" style="width:80px;">
            </div>
    ...
    <div id="getStarted" style="width:100%;">
        <div style="display:flex; justify-content:center; align-items:center; flex-direction:column;">
            ...
            <img src="/imgs/gamersplay-gp-services.png" style="height:400px !important; max-width:100%; object-fit:contain;" alt="">
    ...
    <div id="loader" style="display:none; flex-direction:column; align-items:center;justify-content:center;">
        <h4>Loading...</h4>
        <lottie-player src="https://assets1.lottiefiles.com/packages/lf20_y4piddma.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
    </div>
