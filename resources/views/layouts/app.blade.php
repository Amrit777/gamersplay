...
<head>
    ...
    <link href="{{ asset('css/style.css?v=1.2.3') }}" rel="stylesheet">
    ...
    <meta name="description" content="GamersPlay is a  premier destination for finding gamer friends to play with, browse our selection of hundreds of services in gaming and lifestyle categories.">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://gamersplay.gg/">
    <meta property="og:title" content="GamersPlay | Home">
    <meta property="og:description" content="GamersPlay is a  premier destination for finding gamer friends to play with, browse our selection of hundreds of services in gaming and lifestyle categories.">
    ...
    <meta property="twitter:description" content="GamersPlay is a  premier destination for finding gamer friends to play with, browse our selection of hundreds of services in gaming and lifestyle categories.">
    <meta property="twitter:image" content="/imgs/astronaut.png">


    {{-- SEO optimization KWs --}}
    <meta name="keywords" content="gaming website, meet new friends, socialize, find new gaming friend, gamersplay, play games, play games online, online, online gaming, gaming services, csgo, lol, dota2, pubg, gaming,friends,total gaming,gaming friends,making friends,green gaming,gaming music,family friendly,online gaming,kid friendly,game with friends,no friends,online friends,#friends,ff game with friends,games to make friends,as gaming,gaming funny,as gaming free fire,make friends video games">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/services">
                                <div class="nav-link-icon-container">
                                    <img src="{{asset('/imgs/icons/puzzle.svg')}}" class="nav-link-icon">
                                </div>
                                Services
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/news">
                                <div class="nav-link-icon-container">
                                    <img src="{{asset('/imgs/icons/friendship.svg')}}" class="nav-link-icon">
                                </div>
                                News</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/rankings">
                                <div class="nav-link-icon-container">
                                    <img src="{{asset('/imgs/icons/rank3.svg')}}" class="nav-link-icon">
                                </div>
                                Rankings</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/frequently-asked-questions">
                                <div class="nav-link-icon-container">
                                    <img src="{{asset('/imgs/icons/conversation.svg')}}" class="nav-link-icon">
                                </div>
                                F.A.Q
                            </a>
                        </li>
                    ...
                    <ul class="navbar-nav ml-auto auth-links">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="btn login-btn" id="loginModalBtn"
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="btn register-btn"  id="registerModalBtn"
                                    style="cursor: pointer;"
                                    data-toggle="modal" 
                                    data-target="#registerModal" data-backdrop="static" data-keyboard="false">
                        ...
                        <li class="nav-item">
                            <div style="margin-right:25px; display:flex; justify-content:center; padding:10px 0;">
                                <input type="text" style="width:250px; text-align:center; background:transparent; color:white; border:1px solid rgba(255,255,255,0.3);" id="search" placeholder="Search">
                                <div id="myDropdown" class="dropdown-content" style="border-radius:4px; width:250px; min-height:50px; margin-top:40px;">

                                    <div id="spinner" style="display:flex; justify-content:center; align-items:center; height:100%; width:100%; margin:10px 0;">
                    
                                        <div class="spinner-border" role="status" style="display:Flex; justify-content:center;align-items:center;">
                        ...
                        <li class="nav-item spaced-out-lg">
                            <a href="/points" class="nav-link" style="height:100%; display:flex; justify-content:center; align-items:center;">
                                <span class="badge badge-pill badge-points">{{Auth::user()->points}} GP <img src="/imgs/icons/coin3.svg" style="height:20px; margin-left:5px;"></span>
                            </a>
                        </li>
